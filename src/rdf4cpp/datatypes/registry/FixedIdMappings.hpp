...
inline constexpr util::StaticFlatMap reserved_datatype_ids{
        ...
        ReservedDatatypeIdEntry{xsd_dateTimeStamp, LiteralType::from_parts(LiteralTypeTag::Default, 8)},
        ReservedDatatypeIdEntry{xsd_gYear,         LiteralType::from_parts(LiteralTypeTag::Default, 9)},
        ReservedDatatypeIdEntry{xsd_gMonth,        LiteralType::from_parts(LiteralTypeTag::Default, 10)},
        ReservedDatatypeIdEntry{xsd_gDay,          LiteralType::from_parts(LiteralTypeTag::Default, 11)},
        ReservedDatatypeIdEntry{xsd_gYearMonth,    LiteralType::from_parts(LiteralTypeTag::Default, 12)},
        ReservedDatatypeIdEntry{xsd_gMonthDay,     LiteralType::from_parts(LiteralTypeTag::Default, 13)},
